...
{
    public partial class dscw_dy : System.Web.UI.Page
    {
        ...
        protected void BindGird(string dt1, string dt2, string sendto, int printStat)
        {
            ...
            if (printStat == 0)
            {
                string sqlCmd = "select c.TradeNo,b.GoodsName,b.GoodsNO,Convert(decimal(18,2),a.sellCount) as sellCount,d.NickName,c.confirmTime,c.SndTo,c.Province,a.RecID,('未打印') as printstat,e.name as postName  from G_Trade_GoodsList a";
            ...
            if (printStat == 1)
            {
                string sqlCmd = "select c.TradeNo,b.GoodsName,b.GoodsNO,Convert(decimal(18,2),a.sellCount) as sellCount,d.NickName,c.confirmTime,c.SndTo,c.Province,a.RecID,('已打印') as printstat,e.name as postName from G_Trade_GoodsList a";
                sqlCmd += " left join G_Goods_GoodsList b on a.GoodsID=b.GoodsID";
                sqlCmd += " left join G_Trade_TradeList c on a.TradeID=c.TradeID";
                sqlCmd += " left join G_Customer_CustomerList d on c.CustomerID=d.CustomerID";
                sqlCmd += " left join G_Cfg_LogisticList e on c.LogisticID=e.LogisticID";
            ...
            if (printStat == 2)
            {
                string sqlCmd = "select c.TradeNo,b.GoodsName,b.GoodsNO,Convert(decimal(18,2),a.sellCount) as sellCount,d.NickName,c.confirmTime,c.SndTo,c.Province,a.RecID,";
