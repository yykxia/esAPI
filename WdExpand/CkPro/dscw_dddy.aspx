<%@ Page Language="C#" AutoEventWireup="True" Inherits="WdExpand.CkPro.dscw_dddy" CodeBehind="~/CkPro/dscw_dddy.aspx.cs" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="数据查询"
             EnableCollapse="true" runat="server" DataKeyNames="RecID" EnableCheckBoxSelect="true">
            <Toolbars>
                <f:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        ...
                        <f:Button ID="Button1" Text="打印" runat="server" OnClick="Button1_Click"></f:Button>
...
<%--                <f:WindowField ColumnID="PrintWindow" TextAlign="Center" Icon="Printer" ToolTip="打印预览" HeaderText="打印预览"
                     WindowID="Window1" DataIFrameUrlFields="RecID" DataIFrameUrlFormatString="dscw_printdtl.aspx?ddls={0}" Width="80px" />                               --%>
            </Columns>
        </f:Grid>
                </Items>
            </f:Panel>
